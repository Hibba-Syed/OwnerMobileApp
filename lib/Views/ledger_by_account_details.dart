                ...
                children: [
                          ...
                          child: CustomText(
                              text: ledgerAccountDatum?.document
                                  ...
                                  : ledgerAccountDatum?.document == "" ||
                                          ledgerAccountDatum?.document == " "
                                      ? "JV"
                                      : ledgerAccountDatum?.document ?? "JV")),
                    ],
                  ),
                  const Gap(10),
                  Row(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      CustomText(
                        text: formatCurrency(ledgerAccountDatum?.debit ?? 0),
                        fontsize: 13,
                      ),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      CustomText(
                        text: formatCurrency(ledgerAccountDatum?.credit ?? 0),
                        fontsize: 13,
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      CustomText(
                        text: formatCurrency(ledgerAccountDatum?.balance ?? 0),
                        fontsize: 13,
                      ),
                    ],
                  ),

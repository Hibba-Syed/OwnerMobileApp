        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              Expanded(
                child: BlocBuilder<HappinessCenterCubit, HappinessCenterState>(
                  builder: (context, happinessCenterState) {
                                    ...
                                    const DashboardPage().iconButton(
                                      ...
                                      color:
                                          state.complaintType.toLowerCase() ==
                                              ...
                                              : kWhite,
                                      onTap: () {
                                        if (happinessCenterState.loadingState ==

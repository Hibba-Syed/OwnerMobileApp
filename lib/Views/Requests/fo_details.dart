                ...
                children: [
                  const AdDetailsPage().header(
                      ...
                      state.foDetailsModel?.record?.status, [
                    {
                      ...
                      "subTitle":
                          state.foDetailsModel?.record?.clientType ?? " -- ",
                    },
                    {
                      "icon": Icons.person_outlined,
                      "title": "Contractor Name",
                      "subTitle": state.foDetailsModel?.record?.clientName,
                    },
                    {
                    ...
                    },
                    {
                      ...
                      "title": "Description",
                      "subTitle":
                          state.foDetailsModel?.record?.description ?? " -- ",
                    },
                  ]),
                  ...
                  const AdDetailsPage().supportingDocuments(context, [
                    ...
                    {
                      "name": "ID File",
                      "url": state.foDetailsModel?.record?.clientIdFileUrl,
                    },
                    {
                      "name": "Passport File",
                      "url": state.foDetailsModel?.record?.passportFileUrl,
                    },
                  ])
                ],
              ),

...
class UnitFinancialsModel {
  ...
  factory UnitFinancialsModel.fromJson(Map<String, dynamic> json) =>
      UnitFinancialsModel(
        ...
        unitSummaries: json["unit_summaries"] == null
            ? []
            : List<UnitSummary>.from(
                json["unit_summaries"]!.map((x) => UnitSummary.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "unit_summaries": unitSummaries == null
            ? []
            : List<dynamic>.from(unitSummaries!.map((x) => x.toJson())),

...
CommunitiesModel communitiesModelFromJson(String str) => CommunitiesModel.fromJson(json.decode(str));
...
class CommunitiesModel {
    ...
    factory CommunitiesModel.fromJson(Map<String, dynamic> json) => CommunitiesModel(

...
ComplianceDetailsModel complianceDetailsModelFromJson(String str) => ComplianceDetailsModel.fromJson(json.decode(str));

String complianceDetailsModelToJson(ComplianceDetailsModel data) => json.encode(data.toJson());
...
class ComplianceDetailsModel {
    ...
    factory ComplianceDetailsModel.fromJson(Map<String, dynamic> json) => ComplianceDetailsModel(
        status: json["status"],

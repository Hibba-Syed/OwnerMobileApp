...
//
//     final miDetailsModel = miDetailsModelFromJson(jsonString);

import 'dart:convert';

import 'ad.dart';

MiDetailsModel miDetailsModelFromJson(String str) =>
    MiDetailsModel.fromJson(json.decode(str));

String miDetailsModelToJson(MiDetailsModel data) => json.encode(data.toJson());

class MiDetailsModel {
  String? status;
  Record? record;
  int? code;
  dynamic meta;
  ...
  factory MiDetailsModel.fromJson(Map<String, dynamic> json) => MiDetailsModel(
        status: json["status"],
...
class Application {
  ...
  factory Application.fromJson(Map<String, dynamic> json) => Application(
        ...
        residentInformation: json["resident_information"] == null
            ? null
            : Record.fromJson(json["resident_information"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "resident_information": residentInformation?.toJson(),
      };
}

...
//
//     final dpDetailsModel = dpDetailsModelFromJson(jsonString);

import 'dart:convert';

DpDetailsModel dpDetailsModelFromJson(String str) =>
    DpDetailsModel.fromJson(json.decode(str));

String dpDetailsModelToJson(DpDetailsModel data) => json.encode(data.toJson());

class DpDetailsModel {
  String? status;
  Record? record;
  int? code;
  dynamic meta;
  ...
  factory DpDetailsModel.fromJson(Map<String, dynamic> json) => DpDetailsModel(
        status: json["status"],
...
class Application {
  ...
  factory Application.fromJson(Map<String, dynamic> json) => Application(
        ...
        application: json["application"] == null
            ? null
            : Record.fromJson(json["application"]),
      );

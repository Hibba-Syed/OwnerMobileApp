...
CsDetailsModel csDetailsModelFromJson(String str) => CsDetailsModel.fromJson(json.decode(str));

String csDetailsModelToJson(CsDetailsModel data) => json.encode(data.toJson());
